...
{   
    ...
    for(count =0; count <=6; count++)
    {
        if(count<= 2)
        {
            var divcontent = "<div class='col-lg-4' id='AppendedImages'><img id='AppendImage' src=\""+generateURL()+"\" onclick=\"getSelectedImageLinks(this)\"/></div>";
        ...
        if(count === 6){
            var divcontent = "<div id='AppendedImage'><img id='AppendImage' src=\""+ generateURL() +"\" onclick=\"getSelectedImageLinks(this)\"/></div>";
            document.getElementById('sideAppendedImages').innerHTML = divcontent;
            animateById('AppendImage','zoomIn');
        }
    }

    var carouselcontent = "<div class=\"carouselbox\"><ol class=\"content\"><li><img id=\"AppendImage\" src=\""+generateURL()+"\" onclick=\"getSelectedImageLinks(this)\" /></li><li><img id=\"AppendImage\" src=\""+generateURL()+"\" onclick=\"getUrl(this)\" /></li><li><img id=\"AppendImage\" src=\""+generateURL()+"\" onclick=\"getUrl(this)\" /></li><li><img id=\"AppendImage\" src=\""+generateURL()+"\" onclick=\"getUrl(this)\" /></li><li><img id=\"AppendImage\" src=\""+generateURL()+"\" onclick=\"getUrl(this)\" /></li><li><img id=\"AppendImage\" src=\""+generateURL()+"\" onclick=\"getUrl(this)\" /></li></ol><div class=\"buttons\"><button class=\"prev\">◀</button><button class=\"next\"> ▶ </button></div></div>";
